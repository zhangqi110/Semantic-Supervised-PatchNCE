...
class Launcher(TmuxLauncher):
    def common_options(self):
        return [
            # Command 0
            Options(
                dataroot="/mnt/bn/liuchen-lq-0228/zhangqi/AdaptiveSupervisedPatchNCE/data/HER2/TrainValAB",
                name="ssp_test_wsrc_01",
                ...
                # bsp loss setting
                lambda_bsp=0.0,
                bsp_layers_patches='256,256,256,256,256',
    ...
    def commands(self):
        return ["python3 train.py" + str(opt) for opt in self.common_options()]
    ...
    def test_commands(self):
        ...
        return ["python3 test.py " + str(opt.set(phase=phase)) for opt in opts]
